...
function View_vimOnPage(wWin,hWin,wImg,hImg)
{
   ...
   if (aCalcPicOnDiv.wpimg==100 && aCalcPicOnDiv.hpimg==100) 
   {
      ...
      console.log('p_widthImg='+alignImg.p_widthImg+'  p_heightImg='+alignImg.p_heightImg);
      View_isInside(wWin,hWin,alignImg.p_widthImg,alignImg.p_heightImg)
   }
...
function setAlignImg(widthDiv,heightDiv,wImg,hImg)
{
   ...
   let p1_widthImg=Math.floor(k1*wImg)-5;
   let p1_heightImg=Math.floor(k1*hImg)-5;
   ...
   else
   {
      ...
      let p2_widthImg=Math.floor(k2*p1_widthImg)-5;
      let p2_heightImg=Math.floor(k2*p1_heightImg)-5;
      alignImg=
      { 
