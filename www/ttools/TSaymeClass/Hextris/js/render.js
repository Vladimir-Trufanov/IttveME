...
function renderBeginningText() {
    ...
    if(/mobile|Mobile|iOS|Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
        mob = true;
        input_text = 'Кликайте по экрану с правой или левой стороны '
        action_text = 'экрана, чтобы вращать хексагон'
        score_text = 'Соедините 3 и более блоков для набора очков!'
        fontSize = 35
    } else {
        mob = false
        input_text = 'Жмите стрелки вправо-влево или кликайте '
        action_text = 'мышкой, чтобы вращать хексагон'
        score_text = 'Соедините 3 и более блоков для набора очков!'
        fontSize = 27
    }
