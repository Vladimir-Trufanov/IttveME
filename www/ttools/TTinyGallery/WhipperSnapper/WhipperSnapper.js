...
let canvas=document.createElement('canvas'); // холст для рисования
var ctx=canvas.getContext('2d');             // контекст
var bg=[95,158,160];                         // цвет холста
...
console.log('heightCanvas='+heightCanvas);
  ...
  context.rect(leftCanvas,topCanvas,widthCanvas,300);
