// PHP7/HTML5, EDGE/CHROME                            *** WhipperSnapper.js ***

// ****************************************************************************
// * ittve.me                           Игровой блок созерцаний при появлении *
// *                                                    отложенного сообщения *
// *                                                                          *
// * v1.0, 13.03.2023                               Автор:      Труфанов В.Е. *
// * Copyright © 2023 tve                           Дата создания: 09.01.2023 *
// ****************************************************************************

// Перезагружаем страницу при изменении размеров окна браузера
...
function СursorSnake()
{
   ...
   SnakeCanvas.height = window.innerHeight-15;
