...
class TinyGallery
{
   ...
   private function OtherGallery()
   {
      ...
      try 
      {
         ...
         $mail->addAddress('tve58@inbox.ru', 'tve'); //Add a recipient
      ...
      $mail->SMTPAuth = true;
      $mail->Username = 'tve58@inbox.ru';               //$smtpUsername;
      $mail->Password = 'secret';                       //$smtpPassword;
      $mail->setFrom('tve@karelia.ru', 'Mailer');       //($emailFrom, $emailFromName);
      $mail->addAddress('tve58@inbox.ru', 'ToMailer');  //($emailTo, $emailToName);
      ...
      */
      ...
      //$isSrc='Калиниченко Е.Е. Думы у печки. 1897';  
      //require_once "ttools/TEntryClass/DumyUPechki.php"; 
   
      /* 2 опыт          
      phpinfo();
      */
   } 
   // Для работы собственно развернуть галерею
   ...
   // *************************************************************************
   // *          Развернуть пространство просмотра или редактирования         *
   // *************************************************************************
