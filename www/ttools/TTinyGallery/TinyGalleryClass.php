...
class TinyGallery
{
   ...
   private function OtherGallery()
   {
      ...
      echo password_verify('Password435',$hash_default_salt)."<br>"; 
      echo password_verify('Password435',$hash_variable_salt)."<br>"; 
      echo password_verify('Password123',$hash_default_salt).'123'; 
      */
